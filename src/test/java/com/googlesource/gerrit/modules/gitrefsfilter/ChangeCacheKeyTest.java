...
public class ChangeCacheKeyTest {
  ...
  public void shouldExcludeRepoFieldDuringEqualsCalculation() throws IOException {
    ChangeCacheKey cacheKey1 =
        ChangeCacheKey.create(getRepository(), ID, CHANGE_REVISION, TEST_REPO);
  ...
  private Repository getRepository() throws IOException {
    DfsRepositoryDescription desc = new DfsRepositoryDescription(REPO_NAME);
    return new InMemoryRepository.Builder().setRepositoryDescription(desc).build();
  }
}
