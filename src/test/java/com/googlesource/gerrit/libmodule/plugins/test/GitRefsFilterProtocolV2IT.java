...
public class GitRefsFilterProtocolV2IT extends AbstractGitDaemonTest {
  ...
  public void testGitWireProtocolV2HidesAbandonedChange() throws Exception {
    ...
    String gitProtocolOutAbandonedChange = execFetch(allRefsVisibleProject, visibleChangeNumberRef);
    assertThat(gitProtocolOutAbandonedChange).doesNotContain(visibleChangeNumberWithSha1);
  }
