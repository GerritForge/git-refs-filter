...
public class ChangesTsCache {
  ...
  public static Module module() {
    return new CacheModule() {
      ...
      protected void configure() {
        cache(CHANGES_CACHE_TS, ChangeCacheKey.class, new TypeLiteral<Timestamp>() {})
            .loader(Loader.class);
      }
    };
  }
  ...
  @Singleton
  static class Loader extends CacheLoader<ChangeCacheKey, Timestamp> {
    ...
    @Override
    public Timestamp load(ChangeCacheKey key) throws Exception {
      ChangeNotes changeNotes =
          changeNotesFactory.createChecked(
              key.repo(), key.project(), key.changeId(), key.changeRevision());
      return changeNotes.getChange().getLastUpdatedOn();
    }
  }
}
