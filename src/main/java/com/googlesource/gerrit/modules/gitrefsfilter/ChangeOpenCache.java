...
public class ChangeOpenCache {
  public static final String CHANGE_OPEN_CACHE = "change_open_cache";

  public static Module module() {
    return new CacheModule() {
      @Override
      protected void configure() {
        cache(CHANGE_OPEN_CACHE, Key.class, new TypeLiteral<Boolean>() {}).loader(Loader.class);
      }
    };
  }
  ...
  public abstract static class Key {
    ...
    static Key create(
        Repository repo, Change.Id changeId, ObjectId changeRevision, Project.NameKey project) {
